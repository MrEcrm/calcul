package org.noip.mrgreenleaves.chapter13.theorie.test;
...
public class Exercise
{
    ...
    public Exercise(String part)
    {
        ...
        books[5] = new Book("Fontane", "", 10000);
        books[6] = new Book("Fontane", "", 12000);
        if (part.equals("6"))
            part6();
